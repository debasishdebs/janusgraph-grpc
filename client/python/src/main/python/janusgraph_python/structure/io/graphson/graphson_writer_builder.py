...
from ....serializer.point_serializer import PointSerializer
from ....serializer.circle_serializer import CircleSerializer

from ....core.datatypes.relation_identifier import RelationIdentifier
from ....core.datatypes.geo_shape import Point, Circle
