...
class ManagementForVertexLabelsImpl(
    ...
    override fun ensureCompositeIndexByVertexLabel(
        ...
        val index = managementServer.ensureCompositeIndexByVertexLabel(graph, request.vertexLabel, request.index)
        responseObserver?.onNext(index)
        responseObserver?.onCompleted()
    }
    ...
    override fun ensureCompositeIndexForVertex(
        ...
        val index = managementServer.ensureCompositeIndexForVertex(graph, request.index)
        responseObserver?.onNext(index)
        responseObserver?.onCompleted()
    }
    ...
    override fun getCompositeIndicesByVertexLabel(
        ...
        val indices = managementServer.getCompositeIndicesByVertexLabel(graph, request.vertexLabel)
    ...
    override fun getVertexCompositeIndexByName(
        ...
        val index = managementServer.getVertexCompositeIndexByName(graph, request.indexName)
        responseObserver?.onNext(index)
        responseObserver?.onCompleted()
    }
